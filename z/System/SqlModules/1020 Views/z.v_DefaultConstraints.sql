...
as
	select 
			...
			z.fn_GetExpectedName('Default', object_schema_name(d.object_id), object_name(d.parent_object_id), col_name(d.parent_object_id, d.parent_column_id), null, null) ExpectedDefaultObjectName,
